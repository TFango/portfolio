...
function GithubIcon() {
  return (
    <svg width="18" height="20" viewBox="0 0 19 21" fill="none">
      <path
        d="M4.31523 4.199C4.06523 3.561 4.07523 2.832 4.18623 2.165C4.95019 2.39456 5.66779 2.75675 6.30623 3.235C6.58623 3.449 6.95323 3.518 7.29523 3.415C8.17267 3.15182 9.08418 3.01973 10.0002 3.023C10.9612 3.023 11.8742 3.163 12.7032 3.414C13.0452 3.518 13.4122 3.448 13.6912 3.234C14.3294 2.75585 15.0466 2.39367 15.8102 2.164C15.9212 2.831 15.9302 3.56 15.6822 4.197C15.5322 4.581 15.6072 5.023 15.8902 5.337C16.6142 6.14 17.0002 7.063 17.0002 8.023C17.0002 10.137 15.0302 12.21 11.8662 12.841C11.0742 12.999 10.7652 13.996 11.3712 14.567C11.7602 14.933 12.0002 15.449 12.0002 16.023V19.023C12.0002 19.2882 12.1056 19.5426 12.2931 19.7301C12.4807 19.9176 12.735 20.023 13.0002 20.023C13.2654 20.023 13.5198 19.9176 13.7073 19.7301C13.8949 19.5426 14.0002 19.2882 14.0002 19.023V16.023C14.0002 15.453 13.8802 14.911 13.6662 14.42C16.6832 13.373 19.0002 11.016 19.0002 8.023C19.0002 6.676 18.5162 5.438 17.7132 4.401C17.9232 3.581 17.9042 2.755 17.8242 2.121C17.7532 1.553 17.6542 0.809 17.2542 0.365C16.6592 -0.293999 15.6742 0.0940004 14.9742 0.333C14.223 0.58622 13.5084 0.937594 12.8492 1.378C11.9183 1.14008 10.9611 1.0208 10.0002 1.023C9.00623 1.023 8.04723 1.148 7.14923 1.379C6.49001 0.938594 5.7755 0.58722 5.02423 0.334001C4.32423 0.0940006 3.33823 -0.293999 2.74323 0.365C2.33523 0.817001 2.25023 1.502 2.17723 2.084L2.17223 2.122C2.09223 2.757 2.07423 3.584 2.28423 4.405C1.48423 5.441 1.00023 6.677 1.00023 8.023C1.00023 11.015 3.31723 13.373 6.33423 14.42C6.11623 14.9194 6.00258 15.4581 6.00023 16.003L5.83223 16.037C5.11523 16.136 4.65623 16.047 4.34423 15.915C3.58423 15.593 3.19223 14.782 2.71423 14.162C2.41623 13.777 1.98223 13.296 1.31623 13.074C1.1916 13.0325 1.06003 13.016 0.929009 13.0253C0.79799 13.0347 0.670097 13.0697 0.552631 13.1285C0.315397 13.2472 0.135038 13.4553 0.0512294 13.707C-0.032579 13.9587 -0.0129713 14.2334 0.105739 14.4706C0.22445 14.7078 0.432539 14.8882 0.684229 14.972C1.24223 15.158 1.62823 16.114 1.98223 16.538C2.35523 16.986 2.85123 17.454 3.56223 17.756C4.24423 18.046 5.04523 18.149 6.00023 18.032V19.023C6.00023 19.2882 6.10559 19.5426 6.29312 19.7301C6.48066 19.9176 6.73501 20.023 7.00023 20.023C7.26545 20.023 7.5198 19.9176 7.70734 19.7301C7.89487 19.5426 8.00023 19.2882 8.00023 19.023V16.023C8.00023 15.449 8.24023 14.933 8.62923 14.567C9.23623 13.995 8.92623 12.999 8.13423 12.841C4.96923 12.21 3.00023 10.137 3.00023 8.023C3.00023 7.065 3.38523 6.142 4.10823 5.339C4.39123 5.025 4.46523 4.583 4.31523 4.199Z"
        fill="currentColor"
      />
    </svg>
  );
    ...
    >
      <motion.div className="tilt-card-inner" style={{ rotateX, rotateY, scale }}>
        ...
        <motion.div className="tilt-card-overlay" style={{ opacity: overlayOpacity }}>
          <h3>{title}</h3>
          <p>{description}</p>
          <div className="tilt-card-links">
            {githubUrl && (
              <a href={githubUrl} target="_blank" rel="noreferrer" aria-label="Ver repositorio en GitHub">
                <GithubIcon />
              </a>
            )}
            {liveUrl && (
              <a href={liveUrl} target="_blank" rel="noreferrer" aria-label="Ver sitio en vivo">
                <ExternalLinkIcon />
              </a>
            )}
          </div>
